...
import { Button as NormalBtn, Image, Tooltip } from "@nextui-org/react";
...
export default function Home() {
    ...
    const downloadResume = () => {
        const pdfUrl = "https://docs.google.com/document/d/1gTFaF0EXt7S1hOpgyZENjfufCeyIrITCBIoi9rRwdDQ/export?format=pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.download = "Himansu Sekhar Lenka.pdf";
                    ...
                    <Fade duration={1000} direction={"up"} delay={300}>
                        <div className="mt-6 flex :items-center gap-x-5 md:justify-start justify-center">
                            ...
                            <Tooltip color={"secondary"} placement={"top"} content="https://github.com/Himansu173">
                                <NormalBtn isIconOnly onPress={() => window.open("https://github.com/Himansu173", '_blank')} variant="faded" >
                            ...
                            <Tooltip color={"secondary"} placement={"buttom"} content="https://www.x.com/himansu173">
                                <NormalBtn isIconOnly onPress={() => window.open("https://www.x.com/himansu173/", '_blank')} variant="faded" >
                            ...
                            <Tooltip color={"secondary"} placement={"top"} content="https://www.instagram.com/himansu__173">
                                <NormalBtn isIconOnly onPress={() => window.open("https://www.instagram.com/himansu__173/", '_blank')} variant="faded" >
                            ...
                            <Tooltip color={"secondary"} placement={"buttom"} content="https://www.facebook.com/himansus.lenka.9">
                                <NormalBtn isIconOnly onPress={() => window.open("https://www.facebook.com/himansus.lenka.9/", '_blank')} variant="faded" >
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="34px" height="34px" viewBox="0,0,255.99452,255.99452">
